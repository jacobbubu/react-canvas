...
function drawTextRenderLayer (ctx, layer) {
  ...
  if (layer.drawText)
    layer.drawText(ctx, layer.text, layer.frame.x, layer.frame.y, layer.frame.width, layer.frame.height, fontFace, options);
  else
    CanvasUtils.drawText(ctx, layer.text, layer.frame.x, layer.frame.y, layer.frame.width, layer.frame.height, fontFace, options);
}
